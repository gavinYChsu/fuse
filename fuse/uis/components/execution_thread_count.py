...
def render() -> None:
	...
	EXECUTION_THREAD_COUNT_SLIDER = gradio.Slider(
		...
		step = calculate_int_step(fuse.choices.execution_thread_count_range),
		minimum = fuse.choices.execution_thread_count_range[0],
		maximum = fuse.choices.execution_thread_count_range[-1]
	)
