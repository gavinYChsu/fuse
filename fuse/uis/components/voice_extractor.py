...
import fuse.choices
from fuse import state_manager, translator, voice_extractor
from fuse.filesystem import is_video
from fuse.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = fuse.choices.voice_extractor_models,
