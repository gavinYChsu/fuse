...
import fuse.choices
from fuse import content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, state_manager, translator, voice_extractor
from fuse.filesystem import get_file_name, resolve_file_paths
from fuse.processors.core import get_processors_modules
from fuse.types import DownloadProvider
...
def render() -> None:
	...
	DOWNLOAD_PROVIDERS_CHECKBOX_GROUP = gradio.CheckboxGroup(
		...
		choices = fuse.choices.download_providers,
...
def update_download_providers(download_providers : List[DownloadProvider]) -> gradio.CheckboxGroup:
	...
	download_providers = download_providers or fuse.choices.download_providers
