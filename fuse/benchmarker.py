...
import fuse.choices
from fuse import content_analyser, core, state_manager
from fuse.cli_helper import render_table
from fuse.download import conditional_download, resolve_download_url
from fuse.face_store import clear_static_faces
from fuse.filesystem import get_file_extension
from fuse.types import BenchmarkCycleSet
from fuse.vision import count_video_frame_total, detect_video_fps
...
def run() -> Iterator[List[BenchmarkCycleSet]]:
	...
	benchmarks = []
	target_paths = [ fuse.choices.benchmark_set.get(benchmark_resolution) for benchmark_resolution in benchmark_resolutions if benchmark_resolution in fuse.choices.benchmark_set ]
