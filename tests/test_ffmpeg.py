...
import fuse.ffmpeg
from fuse import process_manager, state_manager
from fuse.download import conditional_download
from fuse.ffmpeg import concat_video, extract_frames, merge_video, read_audio_buffer, replace_audio, restore_audio
from fuse.filesystem import copy_file
from fuse.temp_helper import clear_temp_directory, create_temp_directory, get_temp_file_path, resolve_temp_frame_paths
from fuse.types import EncoderSet
...
def get_available_encoder_set() -> EncoderSet:
	...
	return fuse.ffmpeg.get_available_encoder_set()
